"""
Django settings for semantic_netflix project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'n5l0bv+*^(efftg=u_3kdfucepec0(urmfp-$t_+-%&&hk3sj0')
...
ROOT_URLCONF = 'semantic_netflix.urls'
...
WSGI_APPLICATION = 'semantic_netflix.wsgi.application'
